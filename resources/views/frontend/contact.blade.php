                                ...
                                <div class="aside-item-2">
                                    ...
                                    <div class="offset-top-15">
                                        <ul class="list list-unstyled">
                                            <li><span class="page-para icon novi-icon icon-xs text-madison mdi mdi-phone text-middle"></span><a class="text-middle inset-left-10 text-dark" href="tel:#">1-800-1234-567</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="aside-item-2">
                                    ...
                                    <div class="offset-top-15">
                                        <ul class="list list-unstyled">
                                            <li><span class=" page-paraicon novi-icon icon-xs text-madison mdi mdi-email-outline text-middle"></span><a class="text-middle inset-left-10" style="color:#5F9EA0;" href="mailto:info@demolink.org">info@demolink.org</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="aside-item-2">
                                    ...
                                    <div class="offset-top-15">
                                        <div class="unit unit-horizontal unit-spacing-xs">
                                            ...
                                            <div class="unit-body">
                                                <p><a class="text-dark page-para" href="#">2130 Fulton Street San Diego, CA 94117-1080 USA</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="aside-item-2">
                                    ...
                                    <div class="offset-top-15">
                                        <div class="unit unit-horizontal unit-spacing-xs">
                                            ...
                                            <div class="unit-body">
                                                <div>
                                                    <p class="page-para">Mon-Fri: 8:00am-8:00pm</p>
                                                </div>
                                                <div>
                                                    <p class="page-para">Sat: 8:00am-3:00pm</p>
                                                </div>
                                                <div>
                                                    <p class="page-para">Sun: Closed</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
