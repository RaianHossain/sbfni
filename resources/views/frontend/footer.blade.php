                ...
                <ul class="list-unstyled contact-info list">
                  <li>
                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                      ...
                      <div class="unit-body">
                        <a class="text-dark" href="tel:#">01716934024,</a><a class="reveal-block reveal-md-inline-block text-dark" href="tel:#">01716934024</a>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                      ...
                      <div class="unit-body text-left">
                        <a class="text-dark" href="#">SBF Nursing Institute,<br>Sonali Park, Jail Road,<br>Lalmonirhat-5500, Bangladesh.</a>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                      ...
                      <div class="unit-body">
                        <a href="mailto:#" style="color:#5F9EA0;">sbfnil@gmail.com</a>
                      </div>
                    </div>
                  </li>
                </ul>
                ...
                <form class="rd-mailform form-subscribe" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="bat/rd-mailform.php">
                  <div class="form-group">
                    <div class="input-group input-group-sm">
                      <label class="form-label" for="form-email">Your e-mail</label><input class="form-control" id="form-email" type="email" name="email" data-constraints="@Required @Email" /><span class="input-group-btn"><button class="btn btn-default btn-sm" style="background-color:#999999" type="submit">
                          Subscribe
                        </button></span>
                    </div>
                  </div>
