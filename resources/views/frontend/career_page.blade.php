...
margin-left: 0px !important;
          ...
          <section >
            ...
            <p class="page-para">SinaLite was founded to Empower small business owners  in the advertising and marketing sector to boost their sales and profitability. We strive to be a leader by offering high-quality marketing materials through ecommerce and lean manufacturing. 
            </p>
            </div>
    
            <div class="careercontent">
            <h2 class="page-headings">Who We Are</h2>  
            <p  class="page-para">SinaLite offers flexible marketing solutions for business owners in the advertising and marketing sector within North America. With our state-of-the-art manufacturing facility and our online technology, we produce and fulfill over five million orders each year. 
            </p>
            <p  class="page-para">
            In order to provide our clients with innovative solutions, we embrace new developments in e-commerce, manufacturing technology and marketing trends. And everyday, our talented team keeps SinaLite moving towards our company mission.</p>
            </div>
              ...
              <div>
                 ...
                 <p  class="page-para">Everyday at SinaLite, our core beliefs guide us towards achieving our mission as a team.
                  </p>
                  </div>
                  </div>
                  </div>
            ...
            <p  class="page-para">It is our team who makes SinaLite. We come from diverse backgrounds, but we share the same common goal: to empower small business owners in the advertising and marketing sector to boost their sales and profitability.
            </p>
            <p  class="page-para">  
            SinaLite encourages an open culture, where every team member is a hands-on contributor. We are proud to maintain an environment in which employees feel comfortable sharing ideas and suggestions.
            </p>
            <p  class="page-para">
            ...
            <div  class="ctbutton buttontwo"><a href="current-opportunities.html"
