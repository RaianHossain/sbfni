<x-frontend.layouts.master>
        <section class="section breadcrumb-modern context-dark parallax-container text-center" data-parallax-img="images/parallax-03.jpg">
            <div class="parallax-content section-30 section-sm-70">
                <div class="shell">
                    <h2 class="veil reveal-sm-block">Course</h2>
            ...
            <div class="shell">
                <div class="responsive-tabs responsive-tabs-classic vertical" data-type="vertical">
                    <div class="resp-tabs-container text-sm-left tabs-lg-collapsed" data-group="tabs-lg-collapsed">
                        ...
                        <div>
                            <div class="inset-lg-right-60">
                                <h3 class="text-bold veil reveal-lg-block">Course Objectives</h3>
                                <div class="hr divider bg-madison hr-sm-left-0 veil reveal-lg-block"></div>
                                <div class="offset-lg-top-30">
                                    <ol>
                                        ...
                                        <li>Appreciate oneself as a nurse, kind and have positive attitudes toward professional nursing and lifelong learning.</li>
                                    </ol>
                                </div>
                        ...
                        <div>
                            <div class="inset-lg-right-60">
                                <h3 class="text-bold veil reveal-lg-block">Curriculum Design</h3>
                                <div class="hr divider bg-madison hr-sm-left-0 veil reveal-lg-block"></div>
                                <div class="offset-lg-top-30">
                        ...
                        <div>
                            <div class="inset-lg-right-60">
                                <h3 class="text-bold veil reveal-lg-block">Curriculum Structure</h3>
                                <div class="hr divider bg-madison hr-sm-left-0 veil reveal-lg-block"></div>
                                <div class="offset-lg-top-30">
                                    <p>The Diploma in Nursing Science and Midwifery course will be of three years duration  
                                    ...
                                    <h3 class="text-bold veil reveal-lg-block">Year wise subject with code and hours distribution</h3>
                                    <table class="table table-responsive table-bordered border-primary text text-center"  >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="3" class="th text text-center fs-2" style="font-size: 18px">Internal Subject</td>
                                            </tr>
                                            <tr>
                                                <td>D116</td>
                                            ...
                                            <tr >
                                                <td></td>
                                                <td >Total with Internal Subject</td>
                                                <td >1656</td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div>
                            <div class="inset-lg-right-60">
                                <h3 class="text-bold veil reveal-lg-block">Evaluation of students</h3>
                                <div class="hr divider bg-madison hr-sm-left-0 veil reveal-lg-block"></div>
                                <div class="offset-lg-top-30">
                        ...
                        <div>
                            <div class="inset-lg-right-60">
                                <h3 class="text-bold veil reveal-lg-block">Procedures for teaching and placement in clinical areas</h3>
                                <div class="hr divider bg-madison hr-sm-left-0 veil reveal-lg-block"></div>
                                <div class="offset-lg-top-30">
                                    <ul>    The teaching and placement procedure is as follows:
